...
namespace Summ2.Controllers
{
    public class tblCategoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CategoryID,CategoryName")] tblCategory tblCategory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CategoryID,CategoryName")] tblCategory tblCategory)
        {
            if (ModelState.IsValid)
            {
